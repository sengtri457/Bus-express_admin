...
const variantStyles: Record<Variant, string> = {
  ...
  ghost:
    "text-gray-700 hover:bg-gray-100 focus:ring-gray-400 disabled:text-gray-400",
  outline:
    "border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-blue-500 disabled:text-gray-400 disabled:bg-gray-50",
};
